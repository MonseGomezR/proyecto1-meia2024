...
public class BodegaController {
    ...
    @FXML
    private Button agregarProductoButton, ingresarProductoButton, cancelarButton;
    @FXML
    ...
    private ObservableList<Producto> productList;
    ...
    private void getAllProducts() {
        try {
            productos.setAll(bodegaModel.buscarProductos());
    ...
    public void ingresarProducto() {
        try {
            bodegaModel.ingresarDetalle(producto.getId(), Integer.parseInt(cantField.getText()), bodega_actual);
    ...
    private void refreshTable() {
        try {
            var resultado = bodegaModel.getAllDetalles();
            productList.clear();
            productosTable.setItems(productList);
